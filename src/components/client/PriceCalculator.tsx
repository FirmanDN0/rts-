    ...
    <section id="calculator" className="py-24 bg-gray-50 border-t border-gray-200/50 relative">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 text-[#0033A0] mb-3">
            <Calculator className="w-4 h-4 text-[#FDB913]" />
        ...
        {step === 1 && (
          <div className="flex justify-center mb-10">
            <div className="bg-gray-150 p-1 rounded-lg flex items-center space-x-1 border border-gray-200">
              ...
              >
                <Bot className="w-3.5 h-3.5 text-[#FDB913]" />
        ...
        <div className="flex items-center justify-center space-x-4 mb-10 text-xs font-semibold uppercase tracking-widest text-slate-400">
          <span className={step >= 1 ? 'text-[#0033A0] font-bold' : ''}>1. Detail Kebutuhan</span>
          <span className="w-8 h-px bg-gray-200" />
          <span className={step >= 2 ? 'text-[#0033A0] font-bold' : ''}>2. Kontak Client</span>
          <span className="w-8 h-px bg-gray-200" />
          <span className={step >= 3 ? 'text-[#0033A0] font-bold' : ''}>3. Hasil Estimasi</span>
        </div>
        ...
        {step === 1 && activeTab === 'form' && (
          <form onSubmit={handleNextStep} className="glass-panel p-8 md:p-12 rounded-xl shadow-sm space-y-10 animate-scale-in">
            ...
            {formCategory === 'CP' && (
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    <label className="text-xs uppercase tracking-wider text-slate-500 font-bold flex items-center space-x-2">
                      <Video className="w-3.5 h-3.5 text-[#0033A0]" />
                    ...
                    <>
                      ...
                      <div className="space-y-3">
                        ...
                        <input
                          ...
                          className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#0033A0]"
                        />
                ...
                <div className="space-y-4 border-t border-gray-150 pt-6">
                  <div>
                    <h4 className="text-xs uppercase tracking-wider text-slate-700 font-bold flex items-center space-x-2">
                      <Coins className="w-3.5 h-3.5 text-[#0033A0]" />
                      ...
                      return (
                        <div key={param} className="space-y-2">
                          ...
                          <select
                            ...
                            className="w-full bg-gray-50 border border-gray-200 rounded px-2.5 py-1.5 text-xs text-slate-700 focus:ring-1 focus:ring-[#0033A0]"
                          >
                            {options.map(opt => (
            ...
            {formCategory === 'CA' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    <label className="text-xs uppercase tracking-wider text-slate-500 font-bold flex items-center space-x-2">
                      <FileText className="w-3.5 h-3.5 text-[#0033A0]" />
            ...
            <div className="flex justify-end pt-4 border-t border-gray-150">
              <button
                type="submit"
                className="group flex items-center justify-center space-x-2 bg-[#0033A0] text-white font-bold text-xs tracking-widest px-8 py-4 rounded hover:bg-[#002D9C] transition-all duration-300 shadow-md"
              >
        ...
        {step === 1 && activeTab === 'ai' && (
          <form onSubmit={handleNextStep} className="glass-panel p-8 md:p-12 rounded-xl shadow-sm space-y-6 animate-scale-in">
            <div className="space-y-3">
              <label className="text-xs uppercase tracking-wider text-slate-500 font-bold flex items-center space-x-2">
                <Sparkles className="w-4 h-4 text-[#FDB913] animate-pulse" />
              ...
              <textarea
                ...
                rows={6}
                required
                className="w-full glass-input px-5 py-4 text-sm focus:ring-1 focus:ring-[#0033A0] focus:border-[#0033A0] resize-none leading-relaxed"
              />
          ...
          <form onSubmit={handleSubmit} className="glass-panel p-8 md:p-12 rounded-xl shadow-sm space-y-8 animate-scale-in max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-wider text-slate-500 font-semibold">
                  Nama Lengkap / Instansi <span className="text-[#0033A0] font-bold">*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-wider text-slate-500 font-semibold">
                  Nomor WhatsApp (Aktif) <span className="text-[#0033A0] font-bold">*</span>
                </label>
                <input
                  type="tel"
                  required
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full glass-input px-4 py-3 text-sm focus:ring-1 focus:ring-[#0033A0] focus:border-[#0033A0] resize-none"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-150">
              ...
              <button
                type="submit"
                disabled={loading}
                className="group flex items-center justify-center space-x-2 bg-[#0033A0] text-white font-bold text-xs tracking-widest px-8 py-4 rounded hover:bg-[#002D9C] transition-all duration-300 shadow-md disabled:opacity-50"
              >
                {loading ? (
                  <>
        ...
        {step === 3 && minPrice !== null && maxPrice !== null && (
          <div className="glass-panel p-8 md:p-12 rounded-xl shadow-md space-y-10 text-center animate-scale-in relative overflow-hidden max-w-4xl mx-auto">
            <div className="absolute top-0 right-0 w-36 h-36 bg-[#0033A0]/5 rounded-full blur-3xl pointer-events-none" />

            <div className="space-y-3">
              <div className="mx-auto w-12 h-12 rounded-full bg-[#0033A0]/10 text-[#0033A0] flex items-center justify-center mb-4">
                <Sparkles className="w-6 h-6 text-[#FDB913]" />
              </div>
              <span className="text-xs uppercase tracking-[0.25em] text-[#0033A0] font-bold block">
              ...
              {calculationBreakdown?.category && (
                <div className="inline-flex items-center px-3 py-1 rounded bg-[#0033A0]/5 border border-[#0033A0]/20 text-xs font-bold text-[#0033A0] uppercase tracking-wider">
            ...
            {aiAnalysisText && (
              <div className="bg-[#0033A0]/5 border border-[#0033A0]/10 rounded-lg p-5 text-left max-w-2xl mx-auto space-y-2">
                <h5 className="text-[10px] uppercase font-bold text-[#0033A0] tracking-wider flex items-center space-x-1.5">
                  <Bot className="w-3.5 h-3.5 text-[#FDB913]" />
            ...
            <div className="bg-gray-50 border border-gray-150 rounded-lg p-6 max-w-2xl mx-auto space-y-4 shadow-sm text-left">
              <div className="flex items-center justify-between text-xs tracking-wider">
                ...
                <span className="text-[#0033A0] font-bold">AKTIF</span>
              </div>
              ...
              <p className="text-[10px] text-slate-400 leading-relaxed">
                Gunakan kode di atas pada halaman <a href="/tracking" target="_blank" className="text-[#0033A0] font-semibold underline hover:text-[#002D9C]">Track Project</a> untuk memantau proses negosiasi dan kesiapan produksi oleh tim RTS secara real-time.
              </p>
            </div>
