      ...
      <footer className="bg-white border-t border-gray-200/50 pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs md:text-sm text-slate-500 font-light">
              <li><a href="#portfolio" className="hover:text-[#0033A0] transition-colors">Portfolio</a></li>
              <li><a href="#services" className="hover:text-[#0033A0] transition-colors">Layanan Studio</a></li>
              <li><a href="#offers" className="hover:text-[#0033A0] transition-colors">Update & Promo</a></li>
              <li><a href="#calculator" className="hover:text-[#0033A0] transition-colors">Estimasi Harga</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-xs text-slate-500 font-light">
              <li className="flex items-center space-x-2.5">
                <Mail className="w-4 h-4 text-[#0033A0]/70" />
                <span>hello@rencanatuhan.com</span>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="w-4 h-4 text-[#0033A0]/70" />
                <span>+62 812-3456-7890</span>
              </li>
              <li className="flex items-start space-x-2.5">
                <MapPin className="w-4 h-4 text-[#0033A0]/70 mt-0.5" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2.5 rounded bg-gray-50 border border-gray-200 hover:border-[#0033A0] text-slate-500 hover:text-[#0033A0] transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 pt-8 border-t border-gray-200/50 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-slate-400 tracking-wider">
          ...
          <div className="flex space-x-6">
            <a href="/admin" className="hover:text-[#0033A0] transition-colors">Portal Admin</a>
            <span>•</span>
            <a href="#" className="hover:text-[#0033A0] transition-colors">Privacy Policy</a>
            <span>•</span>
            <a href="#" className="hover:text-[#0033A0] transition-colors">Terms of Service</a>
          </div>
        </div>
      </footer>
    </>
