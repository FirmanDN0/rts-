  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        {/* Interactive Standardized Catalog Packages */}
        <CatalogSection />
      ...
      <footer className="bg-white border-t border-gray-200/50 pt-16 sm:pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-16">
          {/* Brand Info */}
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-xs sm:text-sm font-light leading-relaxed max-w-xs">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-slate-500 font-light">
              <li><a href="#catalog" className="hover:text-[#0033A0] font-medium text-[#0033A0] transition-colors">Katalog Paket ✦</a></li>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-xs text-slate-500 font-light">
              <li className="flex items-center space-x-2.5">
                <Mail className="w-4 h-4 text-[#2F3A8F]/70 shrink-0" />
                <span>hello@rencanatuhan.com</span>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="w-4 h-4 text-[#2F3A8F]/70 shrink-0" />
                <span>+62 812-3456-7890</span>
              </li>
              <li className="flex items-start space-x-2.5">
                <MapPin className="w-4 h-4 text-[#2F3A8F]/70 mt-0.5 shrink-0" />
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a
                ...
                className="p-2.5 rounded-xl bg-gray-50 border border-gray-200 hover:border-[#2F3A8F] text-slate-500 hover:text-[#2F3A8F] active:scale-95 transition-all duration-300"
              >
        ...
        {/* Copyright */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-8 border-t border-gray-200/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] sm:text-[11px] text-slate-400 tracking-wider text-center sm:text-left">
