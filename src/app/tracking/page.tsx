      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 animate-scale-in">
        <div className="glass-panel py-8 px-6 sm:px-10 rounded-xl shadow-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="group flex items-center justify-center space-x-2 w-full bg-[#2F3A8F] text-white font-bold text-xs tracking-widest py-3.5 rounded hover:bg-[#1E255C] transition-all duration-300 shadow-sm"
            >
