              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-150 pt-4">
                    ...
                    <div className="flex items-center space-x-1 text-lg font-bold text-[#2F3A8F]">
                      <DollarSign className="w-4.5 h-4.5 text-[#F2B705]" />
                  ...
                  <button
                    ...
                    className="flex items-center justify-center space-x-2 w-full bg-gray-50 border border-gray-200 hover:border-[#2F3A8F] hover:bg-[#2F3A8F]/5 text-slate-700 font-semibold text-xs tracking-wider py-2.5 rounded transition-all duration-300"
                  >
                    <Edit2 size={13} className="text-[#2F3A8F]" />
          ...
          >
            ...
            <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
              <h3 className="text-sm uppercase tracking-widest font-semibold text-slate-800 flex items-center space-x-2">
                <Settings2 size={16} className="text-[#2F3A8F]" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative rounded-md shadow-sm">
                  <input
                    ...
                    className="w-full glass-input pl-10 pr-4 py-2.5 text-sm font-semibold tracking-wide text-[#2F3A8F]"
                  />
